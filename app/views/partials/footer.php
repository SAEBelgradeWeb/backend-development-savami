<footer class="px-3 py-8 bg-white text-2 text-gray-500 transition-colors duration-200 shadow-inner w-full mt-auto">
    <div class="flex flex-col">
        ...
        <div class="mt-4 md:mt-0 flex flex-col md:flex-row">
            <nav class="flex-1 flex flex-col items-center justify-center md:items-end md:border-r border-gray-100 md:pr-5">
                ...
                <?php if (!$_SESSION) : ?>
                    <a aria-current="page" href="/login" class="hover:text-gray-700 dark:hover:text-white">
                        Log In
                    </a>
                    <a aria-current="page" href="/register" class="hover:text-gray-700 dark:hover:text-white">
                        Register
                    </a>
                <?php else : ?>

                    <?php if ($_SESSION['user']->role_id == '1') : ?>
                        <a aria-current="page" href="/admin-panel" class="hover:text-gray-700 dark:hover:text-white">
                            Admin Panel
                        </a>
                    <?php endif ?>

                    <?php if ($_SESSION['user']->role_id == '2') : ?>
                        <a aria-current="page" href="/user/listings" class="hover:text-gray-700 dark:hover:text-white">
                            Manage your listings
                        </a>
                    <?php endif ?>
                    <a aria-current="page" href="/logout" class="hover:text-gray-700 dark:hover:text-white">
                        Log Out
                    </a>
                <?php endif; ?>
            </nav>
            ...
            <div class="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
                <a class="hover:text-primary-gray-20" href="https://github.com/savami">
                    <span class="sr-only">
                        View on GitHub
                    </span>
                ...
                <a class="ml-4 hover:text-primary-gray-20" href="/admin-panel">
                    <span class="sr-only">
                        Settings
                    </span>
            ...
            <div class="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
                ...
                <span class="mt-7 md:mt-1">
                    Created by
                    <span> Sava Miljković</span>
                </span>
                <p>PHP CRUD Final Project</p>
            </div>
        </div>
    </div>
</footer>
